...
String creditCardtype(String ccNum){
  if(ccNum.substring(0,1)).equals("4")){
    return "Visa";
  } else if (ccNum.substring(0,2).equals("34") || ccNum.substring(0,2).equals("37")){
  return "Aemrican Express";
  } else if (ccNum.substring(0,2).equals("36")){
    return "Diner's Club";
  } else if (ccNum.substring(0,2).equals("51") || ccNum.substring(0,2).equals("55")){
    return "Mastercard";
  } else if (ccNum.substring(0,4).equals("6011") || ccNum.substring(0,2).equals("65")){
    return "Discover";
  } else {
