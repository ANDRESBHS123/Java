class Main {
  ...
  */
  String ecoFuel(int MPH , int MPH2){
    if(MPH >= 40 && MPH2 <= 65){
      return "Fuel Economy";
    }else{
      return "Not Optimal";
  ...
  */
  String speedFine(int speed1 , int speed2){
    if(speed1 >= 60 && speed2 <= 70){
      return "You're Driving Legally";
    }else{
      return "FINE: $75 (will increase by $2 for every mile you go over 70)";
    }
  }
